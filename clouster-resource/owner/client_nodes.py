...
@app.route('/v2/resource',methods=['POST'])
def Utilization_resource():
       type = request.form.get("type")
       node = request.form.get("node")
       obj = get_usage()
       if type == 'cpu':
           if node is not None:
               return(str(obj.list_nodes_Region('cpu',node)))
           else:
               return(str(obj.list_nodes('cpu')))
       elif type == 'memory':
           if node is not None:
               return(str(obj.list_nodes_Region('memory',node)))
           else:
               return(str(obj.list_nodes('memory')))
       else:
           return "404"
...
def Load_resource():
       ...
       if type == 'cpu':
           if node is not None:
               return(str(obj.Idle_nodes_resources_Region('cpu',node)))
           else:
               return(str(obj.Idle_nodes_resources('cpu')))
       elif type == 'memory':
           if node is not None:
               return(str(obj.Idle_nodes_resources_Region('memory',node)))
           else:
               return(str(obj.Idle_nodes_resources('memory')))
       else:
           return "404"

@app.route('/v3/resource',methods=['POST'])
def Actual_resource():
       type = request.form.get("type")
       node = request.form.get("node")
       obj = get_usage()
       if type == 'cpu':
           if node is not None:
               return(str(obj.Idle_Cluster_resources_Region('cpu',node)))
           else:
               return(str(obj.Idle_Cluster_resources('cpu')))
       elif type == 'memory':
           if node is not None:
               return(str(obj.Idle_Cluster_resources_Region('memory',node)))
           else:
               return(str(obj.Idle_Cluster_resources('memory')))
       elif type == 'all':
           if node is not None:
               return(obj.Idle_Cluster_node_All(node))
           else:
               return(obj.Idle_Cluster_All())
       else:
           return "404"


@app.route('/v2/resource/region',methods=['POST'])
def Utilization_resource_Region():
       type = request.form.get("type")
       region = request.form.get("region")
       obj = get_usage()
       if type == 'cpu':
           if region is not None:
               return(str(obj.list_nodes_Region('cpu',obj.Get_Label_Region(str(region)))))
           else:
               return "region does not exist"
       elif type == 'memory':
           if region is not None:
               return(str(obj.list_nodes_Region('memory',obj.Get_Label_Region(str(region)))))
           else:
               return "region does not exist"
       else:
           return "404"

@app.route('/v1/resource/region',methods=['POST'])
def Load_resource_Region():
       type = request.form.get("type")
       region = request.form.get("region")
       obj = get_usage()
       if type == 'cpu':
           if region is not None:
               return(str(obj.Idle_nodes_resources_Region('cpu',obj.Get_Label_Region(str(region)))))
           else:
               return "region does not exist"
       elif type == 'memory':
           if region is not None:
               return(str(obj.Idle_nodes_resources_Region('memory',obj.Get_Label_Region(str(region)))))
           else:
               return "region does not exist"
       else:
           return "404"
...
@app.route('/v3/resource/region',methods=['POST'])
def Actual_resource_Region():
       type = request.form.get("type")
       region = request.form.get("region")
       obj = get_usage()
       if type == 'cpu':
           if region is not None:
               return(str(obj.Idle_Cluster_resources_Region('cpu',obj.Get_Label_Region(str(region)))))
           else:
               return "region does not exist"
       elif type == 'memory':
           if region is not None:
               return(str(obj.Idle_Cluster_resources_Region('memory',obj.Get_Label_Region(str(region)))))
           else:
               return "region does not exist"
       elif type == 'all':
           if region is not None:
               return(obj.Idle_Cluster_Region_All(str(region)))
           else:
               return "region does not exist"
       else:
           return "404"
